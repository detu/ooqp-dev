...
void QpGenData::Qmult(double beta, OoqpVector& y, double alpha, OoqpVector& x)
{
	Q->mult(beta, y, alpha, x);
}

void QpGenData::Amult(double beta, OoqpVector& y, double alpha, OoqpVector& x)
{
	A->mult(beta, y, alpha, x);
}

void QpGenData::Cmult(double beta, OoqpVector& y, double alpha, OoqpVector& x)
{
	C->mult(beta, y, alpha, x);
}

void QpGenData::ATransmult(double beta, OoqpVector& y, double alpha, OoqpVector& x)
{
	A->transMult(beta, y, alpha, x);
}

void QpGenData::CTransmult(double beta, OoqpVector& y, double alpha, OoqpVector& x)
{
...
void QpGenData::randomlyChooseBoundedVariables(OoqpVector& x,
                                               OoqpVector& dualx,
                                               OoqpVector& xlow_,
                                               OoqpVector& ixlow_,
                                               OoqpVector& xupp_,
...
void QpGenData::datarandom(OoqpVector& x, OoqpVector& y, OoqpVector& z, OoqpVector& s)
{
	double drand(double*);
	double ix = 3074.20374;

	OoqpVectorHandle xdual(la->newVector(nx));
	this->randomlyChooseBoundedVariables(x, *xdual, *blx, *ixlow, *bux, *ixupp, &ix, .25, .25, .25);
	...
	this->randomlyChooseBoundedVariables(*sprime, z, *bl, *iclow, *bu, *icupp, &ix, .25, .25, .5);
