...
void DenseGenMatrix::atPutDense(int row, int col, double* A, int lda, int rowExtent, int colExtent)
{
...
void DenseGenMatrix::putSparseTriple(int irow[], int len, int jcol[], double A[], int& info)
{
...
void DenseGenMatrix::atPutSpRow(int row, double* A, int lenA, int* jcolA, int& info)
{
...
void DenseGenMatrix::mult(double beta, double y[], int incy, double alpha, double x[], int incx)
{
	char fortranTrans = 'T';
...
void DenseGenMatrix::mult(double beta, OoqpVector& y_in, double alpha, OoqpVector& x_in)
{
	char     fortranTrans = 'T';
	int      n = mStorage->n, m = mStorage->m;
	double** M    = mStorage->M;
...
void DenseGenMatrix::transMult(double beta, OoqpVector& y_in, double alpha, OoqpVector& x_in)
{
	char          fortranTrans = 'N';
	int           n = mStorage->n, m = mStorage->m;
	double**      M    = mStorage->M;
