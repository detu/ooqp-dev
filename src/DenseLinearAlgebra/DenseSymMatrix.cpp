...
void DenseSymMatrix::putSparseTriple(int irow[], int len, int jcol[], double A[], int& info)
{
...
void DenseSymMatrix::mult(double beta, double y[], int incy, double alpha, double x[], int incx)
{
	char fortranUplo = 'U';
	int  n           = mStorage->n;
...
void DenseSymMatrix::mult(double beta, OoqpVector& y_in, double alpha, OoqpVector& x_in)
{
	char          fortranUplo = 'U';
	int           n           = mStorage->n;
...
void DenseSymMatrix::transMult(double beta, OoqpVector& y, double alpha, OoqpVector& x)
{
...
void DenseSymMatrix::atPutDiagonal(int idiag, OoqpVector& v)
{
