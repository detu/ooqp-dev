...
extern "C" void daxpy_(int* n, double* da, double* x, int* incx, double* y, int* incy);

QpBoundResiduals::QpBoundResiduals(QpBound* f, QpBoundData* prob, int nx_in)
{
	factory = f;
...
QpBoundResiduals::QpBoundResiduals(QpBound* f, OoqpVector* rc_, QpBoundData* prob, int nx_in)
{
	factory = f;
...
void QpBoundResiduals::calcresids(Data* prob_in, Variables* vars_in)
{
	double       norm, gap;
