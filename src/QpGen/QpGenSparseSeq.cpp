...
#include "QpGenVars.h"
#include "src/SparseLinearAlgebra/SparseGenMatrix.h"
#include "src/SparseLinearAlgebra/SparseLinearAlgebraPackage.h"
...
void QpGenSparseSeq::joinRHS(OoqpVector& rhs_in,
                             OoqpVector& rhs1_in,
                             OoqpVector& rhs2_in,
                             OoqpVector& rhs3_in)
{
...
void QpGenSparseSeq::separateVars(OoqpVector& x_in,
                                  OoqpVector& y_in,
                                  OoqpVector& z_in,
                                  OoqpVector& vars_in)
{
                               ...
                               char   icupp_[])
{
	...
	QpGenData* data = new QpGenData(SparseLinearAlgebraPackage::soleInstance(), c, Q, xlow, ixlow,
	                                xupp, ixupp, A, b, C, clow, iclow, cupp, icupp);
...
Data* QpGenSparseSeq::copyDataFromSparseTriple(double c[],
                                               ...
                                               char   icupp[])
{
	QpGenData* prob = (QpGenData*)new QpGenData(la, nx, my, mz, nnzQ, nnzA, nnzC);
	int        info;
...
{
	data = new QpGenData(la, nx, my, mz, nnzQ, nnzA, nnzC);
