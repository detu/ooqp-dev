...
public:
	...
	SparseSymMatrix(int size, int nnz, int krowM[], int jcolM[], double M[]);
	...
	virtual void fromGetSpRow(int    row,
	                          int    col,
	                          double A[],
	                          int    lenA,
	                          int    jcolA[],
	...
	virtual void symAtPutSpRow(int col, double A[], int lenA, int jcolA[], int& info);
	...
	virtual void symAtPutSubmatrix(int           destRow,
	                               int           destCol,
	                               DoubleMatrix& M,
	                               int           srcRow,
	                               int           srcCol,
